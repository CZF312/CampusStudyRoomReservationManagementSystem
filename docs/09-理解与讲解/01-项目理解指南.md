...
<colgroup>
  ...
  <tbody>
    ...
    <tr>
      <td style="vertical-align:top;word-break:break-word;">运维脚本 · Ops<br>相关概念：`Java/JDK`=运行 Spring Boot 后端的程序；`MySQL`=关系型数据库，存预约与用户；`index.html`=static 下预构建的前端登录页（HTML）；`Spring Boot`=`mvnw spring-boot:run` 启动的内嵌 Tomcat Web 框架；`application-local.properties`=本地 MySQL 密码配置文件；`setup-after-clone.ps1`=DROP 库并导入 database-full.sql 的子脚本；`database-full.sql`=整库演示数据快照；`PASS=17`=第三版字典 17 项验收；`8080`=浏览器访问端口；`mvnw`=Maven Wrapper</td>
    ...
    <tr>
      <td style="vertical-align:top;word-break:break-word;">运维脚本 · Ops<br>相关概念：`information_schema`=MySQL 系统库，查表数/外键；`Test-Check`=脚本内 PASS/FAIL 计数；`PASS=17`=第三版验收标准；`mysql.exe`=命令行连库执行 SQL；`setup-after-clone.ps1`=导库子脚本；`MySQL`=关系型数据库</td>
...
<colgroup>
  ...
  <tbody>
    ...
    <tr>
      <td style="vertical-align:top;word-break:break-word;">接口层 Controller<br>相关概念：`JWT`=登录通行证 token；`ApiResponse`={code,data,message} 统一响应；`Java`=后端运行时</td>
...
<colgroup>
  ...
  <tbody>
    <tr>
      <td style="vertical-align:top;word-break:break-word;">表现层 Presentation<br>相关概念：`BCrypt`=密码哈希；`Vue`=前端单页框架；v-model；el-form；@click → loginStudent</td>
    ...
    <tr>
      <td style="vertical-align:top;word-break:break-word;">表现层 Presentation<br>相关概念：`localStorage`=浏览器存 token；`MySQL`=关系型数据库；`Vue`=前端单页框架；`JSON`={键:值} 文本格式</td>
...
<colgroup>
  ...
  <tbody>
    ...
    <tr>
      <td style="vertical-align:top;word-break:break-word;">接口层 Controller<br>相关概念：`BCrypt`=密码哈希；`Java`=后端运行时；`registerUpload`=REST 接口转发</td>
    ...
    <tr>
      <td style="vertical-align:top;word-break:break-word;">表现层 Presentation<br>相关概念：`BCrypt`=密码哈希；`Vue`=前端单页框架；POST /auth/register；BCrypt 哈希入库</td>
    ...
    <tr>
      <td style="vertical-align:top;word-break:break-word;">接口层 Controller<br>相关概念：`BCrypt`=密码哈希；`Java`=后端运行时；POST /auth/register；BCrypt 哈希入库</td>
    ...
    <tr>
      <td style="vertical-align:top;word-break:break-word;">业务层 Service<br>相关概念：`BCrypt`=密码哈希；`Java`=后端运行时；POST /auth/register；BCrypt 哈希入库</td>
...
<colgroup>
  ...
  <tbody>
    ...
    <tr>
      <td style="vertical-align:top;word-break:break-word;">接口层 Controller<br>相关概念：`REST`=URL+HTTP 动词；`JSON`={键:值} 文本格式；`JWT`=登录通行证 token；`ApiResponse`={code,data,message} 统一响应；`Java`=后端运行时</td>
...
<colgroup>
  ...
  <tbody>
    ...
    <tr>
      <td style="vertical-align:top;word-break:break-word;">业务层 Service<br>相关概念：`reservation_slot`=10 分钟座位占位；`uk_seat_slot`=唯一索引，防抢座双占；`JdbcTemplate`=Spring 执行 SQL；`Java`=后端运行时</td>
...
<colgroup>
  ...
  <tbody>
    ...
    <tr>
      <td style="vertical-align:top;word-break:break-word;">业务层 Service<br>相关概念：`reservation_slot`=10 分钟座位占位；`Java`=后端运行时；POST /reservations/{id}/checkout；sign_out_time；studyMinutes；status 已完成</td>
...
<colgroup>
  ...
  <tbody>
    ...
    <tr>
      <td style="vertical-align:top;word-break:break-word;">业务层 Service<br>相关概念：`JdbcTemplate`=Spring 执行 SQL；`Java`=后端运行时；noShow grace 宽限；status 已违约；credit 扣分</td>
    ...
    <tr>
      <td style="vertical-align:top;word-break:break-word;">业务层 Service<br>相关概念：`JdbcTemplate`=Spring 执行 SQL；`Java`=后端运行时；过 end_time 自动签退；status 已完成</td>
    ...
    <tr>
      <td style="vertical-align:top;word-break:break-word;">业务层 Service<br>相关概念：`JdbcTemplate`=Spring 执行 SQL；`Java`=后端运行时；blacklist_record 到期解除</td>
...
<colgroup>
  ...
  <tbody>
    ...
    <tr>
      <td style="vertical-align:top;word-break:break-word;">业务层 Service<br>相关概念：`JdbcTemplate`=Spring 执行 SQL；`Java`=后端运行时；INSERT/UPDATE announcement</td>
...
<colgroup>
  ...
  <tbody>
    ...
    <tr>
      <td style="vertical-align:top;word-break:break-word;">业务层 Service<br>相关概念：`JdbcTemplate`=Spring 执行 SQL；`JSON`={键:值} 文本格式；`Java`=后端运行时</td>
